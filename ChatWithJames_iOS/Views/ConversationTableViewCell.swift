...
//  ChatWithJames_iOS
//
//  Created by James Estrada on 2/27/21.
//

import UIKit
import SDWebImage  // download and cache images
        ...
        StorageManager.shared.downloadURL(for: path, completion: { [weak self] result in
            ...
            case .success(let url):
                DispatchQueue.main.async {
                    self?.userImageView.sd_setImage(with: url, completed: nil) // download image and assing it to the image view
                }
