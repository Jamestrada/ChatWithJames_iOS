...
//  ChatWithJames_iOS
//
//  Created by James Estrada on 2/21/21.
//
        ...
        DatabaseManager.shared.getAllMessagesForConversation(with: id, completion: { [weak self] result in
            ...
            case .success(let messages):
                ...
                DispatchQueue.main.async {
                    self?.messagesCollectionView.reloadDataAndKeepOffset() // this will disable scroll all the way down when new message comes
...
extension ChatViewController: InputBarAccessoryViewDelegate {
    func inputBar(_ inputBar: InputBarAccessoryView, didPressSendButtonWith text: String) {
        ...
        DispatchQueue.main.async {
            self.messageInputBar.inputTextView.text = nil // once a text message is sent, clear the input field
        }
...
extension ChatViewController: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
    ...
    func backgroundColor(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> UIColor {
        ...
        if sender.senderId == selfSender?.senderId {
            // Sender's messages' color
            return .link
        }
        // Receiver's messages' color
...
extension ChatViewController: MessageCellDelegate {
    ...
    func didTapImage(in cell: MessageCollectionViewCell) {
        ...
        case .video(let media):
            ...
            vc.player?.play() // automatically play video after the play button was tapped in conversation
